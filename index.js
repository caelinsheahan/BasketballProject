function name(string, count = 0) {
  ...
  if (str.length === 0) {
    ...
    return [Math.round(testname.length/3) + (Math.round(count/14))]
  } else {
...
var playernames = [{
    ...
    },
    {
      ...
      "lastName": "Bogut",
      "scrubBenchStarter": 'aight',
      "primarySkill": 'Thats not a knife'
    },
    {
      "firstName": "Joel",
      "lastName": "Bolomboy",
      "scrubBenchStarter": 'turrible',
      "primarySkill": 'thats my boy'
    },
    {
      "firstName": "Devin",
      "lastName": "Booker",
      "scrubBenchStarter": 'Good',
      "primarySkill": 'TJ Hooker'
    },
    {
      "firstName": "Trevor",
      "lastName": "Booker",
    ...
    },
    {
      ...
      "lastName": "Bradley",
      "scrubBenchStarter": 'turrible',
      "primarySkill": 'who is this'
    },
    {
      "firstName": "Corey",
      "lastName": "Brewer",
      "scrubBenchStarter": 'aight',
      "primarySkill": 'brewer travel'
    },
    {
      "firstName": "Malcolm",
      "lastName": "Brogdon",
    ...
    },
    {
      ...
      "lastName": "Johnson",
      "scrubBenchStarter": 'good',
      "primarySkill": 'oldmanmoves'
    },
    {
      "firstName": "Nikola",
      "lastName": "Jokic",
      "scrubBenchStarter": 'Amazing',
      "primarySkill": 'thejoker'
    },
    {
      "firstName": "DeAndre",
      "lastName": "Jordan",
  ...
  function doSomething(event) {
    ...
    function name(string, count = 0) {
      ...
      if (str.length === 0) {
        ...
        return playernames[Math.round(thename.length/3) + (Math.round(count/14))]
      } else {
        let strloc = str[0].toString()
        count += strloc.charCodeAt(0)
        str.shift()
